...
void Fib::setVert( const unsigned int id, QVector3D& vert )
{
    ...
    {
        qDebug() << "Fib: tried to access vert id out of range";
        exit( 0 );
    }
}
...
QVector3D Fib::firstVert() const
{
    ...
    {
        qDebug() << "Fib: tried to access first vert of empty fib";
        exit( 0 );
    }
}
...
QVector3D Fib::lastVert() const
{
    ...
    {
        qDebug() << "Fib: tried to access last vert of empty fib";
        exit( 0 );
    }
}
...
{
    qDebug() << "to implement Fib::getTangents()";
    exit( 0 );
}
...
QVector3D Fib::getTangent( const unsigned int& id ) const
{
    ...
    {
        qDebug() << "Fib: tried to access tangent id out of range";
        exit( 0 );
    }
}
...
const std::vector<float>* Fib::getDataField( const unsigned int& fieldId ) const
{
    ...
    {
        qDebug() << "Fib: tried to access data field out of range";
        exit( 0 );
    }
}
...
float Fib::getData( const unsigned int& fieldId, const unsigned int& vertId )
{
    if ( fieldId < m_data.size() )
    {
        ...
        {
            qDebug() << "Fib: tried to access data point out of range";
            exit( 0 );
        }
    }
    else
