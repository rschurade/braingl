...
struct core_3_2_context : public QGLContext
{
    ...
    core_3_2_context(const QGLFormat& format, QPaintDevice* device)
        : QGLContext(core_3_2_format(), device)
    {}
    core_3_2_context(const QGLFormat& format)
        : QGLContext(core_3_2_format())
    {}
