                ...
                m_colors_name( "" )
{
    ...
    { "points", "vectors", "pies" }, 0, "general" ); //0 = points, 1 = vectors, 2 = pies
    m_properties["maingl"]->set( Fn::Property::GLYPHRADIUS, 0.01f, 0.0f, 0.5f, "general" );
...
void DatasetGlyphset::setProperties()
{
    ...
    m_properties["maingl"]->set( Fn::Property::SURFACE_GLYPH_GEOMETRY, m_displayList, 0, "general" );
    m_properties["maingl"]->set( Fn::Property::SURFACE_GLYPH_COLOR, m_displayList, 0, "general" );
}
