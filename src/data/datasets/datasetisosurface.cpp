        ...
        for ( unsigned int y = 0; y < m_nY; ++y )
        {
            for ( unsigned int x = 0; x < m_nX; ++x )
            {
                ...
                if ( m_scalarField[ z * nPointsInSlice + ( y + 1 ) * nPointsInXDirection + x ] < m_isoLevel )
                    tableIndex |= 2;
                if ( m_scalarField[ z * nPointsInSlice + ( y + 1 ) * nPointsInXDirection + ( x + 1 ) ] < m_isoLevel )
                    tableIndex |= 4;
                ...
                if ( m_scalarField[ ( z + 1 ) * nPointsInSlice + y * nPointsInXDirection + x ] < m_isoLevel )
                    tableIndex |= 16;
                if ( m_scalarField[ ( z + 1 ) * nPointsInSlice + ( y + 1 ) * nPointsInXDirection + x ] < m_isoLevel )
                    tableIndex |= 32;
                if ( m_scalarField[ ( z + 1 ) * nPointsInSlice + ( y + 1 ) * nPointsInXDirection + ( x + 1 ) ] < m_isoLevel )
                    tableIndex |= 64;
                if ( m_scalarField[ ( z + 1 ) * nPointsInSlice + y * nPointsInXDirection + ( x + 1 ) ] < m_isoLevel )
                    tableIndex |= 128;
...
POINT3DID DatasetIsosurface::calculateIntersection( unsigned int nX, unsigned int nY, unsigned int nZ, unsigned int nEdgeNo )
{
