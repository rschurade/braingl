    ...
    m_renderer( 0 )
{
    ...
    m_properties["maingl"]->set( Fn::Property::D_ORDER, 4 );
    m_properties["maingl"]->set( Fn::Property::D_LOD, 2, 0, 4, "general" );
    m_properties["maingl"]->set( Fn::Property::D_RENDER_FIRST, true, "general" );
    m_properties["maingl"]->set( Fn::Property::D_RENDER_SECOND, false, "general" );
    m_properties["maingl"]->set( Fn::Property::D_RENDER_THIRD, false, "general" );
...
void DatasetBingham::examineDataset()
{
    ...
    if ( type == DT_FLOAT )
    {
        ...
        m_properties["maingl"]->set( Fn::Property::D_MIN, -1.0f );
