        ...
        m_colormapRenderer( 0 )
{
    ...
    m_properties["maingl"]->set( Fn::Property::D_DIM, 1 );
    ...
    m_properties["maingl2"]->set( Fn::Property::D_COLORMAP, 0, "general" );
    m_properties["maingl2"]->set( Fn::Property::D_DIM, 1 );
    m_properties["maingl2"]->set( Fn::Property::D_HAS_TEXTURE, true );

    examineDataset();

    m_properties["maingl"]->set( Fn::Property::D_COLORMAP, 0, "general" );
    ...
    m_properties["maingl"]->set( Fn::Property::D_COLORMAP_TEXT_COLOR, QColor( 1, 1, 1 ), "colormap" );
    m_properties["maingl"]->set( Fn::Property::D_IS_ATLAS, false, "colormap" );
    ...
    m_properties["maingl2"]->set( Fn::Property::D_COLORMAP_TEXT_COLOR, QColor( 1, 1, 1 ), "colormap" );
}
...
void DatasetScalar::examineDataset()
{
    ...
    m_properties["maingl2"]->set( Fn::Property::D_SIZE, static_cast<int>( size * sizeof(float) ) );
    m_properties["maingl2"]->set( Fn::Property::D_MIN, min );
    m_properties["maingl2"]->set( Fn::Property::D_MAX, max );
    m_properties["maingl2"]->set( Fn::Property::D_SELECTED_MIN, min, min, max, "general" );
    m_properties["maingl2"]->set( Fn::Property::D_SELECTED_MAX, max, min, max, "general" );
    m_properties["maingl2"]->set( Fn::Property::D_LOWER_THRESHOLD, min + (max-min)/1000., min, max, "general" );
    m_properties["maingl2"]->set( Fn::Property::D_UPPER_THRESHOLD, max, min, max, "general" );
