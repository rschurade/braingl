...
bool PropertyGroup::contains( int name ) const
{
...
QVariant PropertyGroup::get( Fn::Property name ) const
{
    ...
    {
        return QVariant();
//        qDebug() << "*** ERROR *** GET" << m_properties[Fn::Property::NAME]->getValue().toString() << Property::getNameAsString( name ) << name << "doesnt exist";
//        exit( 0 );
    }
}
...
bool PropertyGroup::set( Fn::Property name, QVariant value )
{
    ...
    {
        //qDebug() << "*** ERROR *** SET" << m_properties[Fn::Property::NAME]->getValue().toString() << Property::getNameAsString( name ) << name << "doesnt exist";
        exit( 0 );
        return false;
    }
}
