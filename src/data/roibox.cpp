    ...
    ROI( QString("new roi") + QString::number( ROI::m_count++ ) )
{
    ...
    m_properties.set( Fn::Property::R_SHAPE, { "ellipsoid", "sphere", "cube", "box" }, 0, "general" );
    m_properties.set( Fn::Property::R_X, x, 0., xMax, "general" );
    m_properties.set( Fn::Property::R_Y, y, 0., yMax, "general" );
    m_properties.set( Fn::Property::R_Z, z, 0., zMax, "general" );
    m_properties.set( Fn::Property::R_DX, 20., 0., xMax, "general" );
    m_properties.set( Fn::Property::R_DY, 20., 0., yMax, "general" );
    m_properties.set( Fn::Property::R_DZ, 20., 0., zMax, "general" );
