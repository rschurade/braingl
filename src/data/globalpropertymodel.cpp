...
GlobalPropertyModel::GlobalPropertyModel()
{
    ...
    m_properties->create( Fn::Property::G_CAMERA_UP_X, 0.0f, -2.0f, 2.0f, "camera" );
    m_properties->create( Fn::Property::G_CAMERA_UP_Y, 0.0f, -2.0f, 2.0f, "camera" );
    m_properties->create( Fn::Property::G_CAMERA_UP_Z, 1.0f, -2.0f, 2.0f, "camera" );
    ...
    m_properties->create( Fn::Property::G_CAMERA_FULLCIRCLE_STEPS, 360, 1, 360, "camera" );
    ...
    m_properties->create( Fn::Property::G_LIGHT_SWITCH, true, "light" );
    m_properties->create( Fn::Property::G_LIGHT_AMBIENT, 0.4f, 0.0f, 1.0f, "light" );
    m_properties->create( Fn::Property::G_LIGHT_DIFFUSE, 1.0f, 0.0f, 1.0f, "light" );
